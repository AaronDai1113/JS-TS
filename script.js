...
const SYMBOLCASE_CHAR_CODES = arrayFromLowToHigh(33,47).concat(
...
form.addEventListener('submit',e=>{
    e.preventDefault()
    const characterAmout= characterAmountNumber.value
...
function generatePassword(characterAmout,includeUppercase,includeNumbers,includeSymbols){
    ...
    if(includeSymbols) charCodes=charCodes.concat(SYMBOLCASE_CHAR_CODES)
